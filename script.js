/*
    ...
    https://ThreePixDroid.com                       : Сайт
    https://www.youtube.com/c/ThreePixDroid         : YouTube
    https://vk.com/threepixdroid                    : VK

    Оставляйте идеи для видео в комментариях на ютубе или вк
...
$(window).ready(function () {
    ...
    let w = canvas.width = $(".pulse").width() * 1.2;                      //ширина равна ширине области просмотра
